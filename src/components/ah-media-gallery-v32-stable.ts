/**
 * Frozen snapshot of the working home gallery after the seamless-loop fix
 * (commit 470403a). Hover-to-play, continuous wrap, no drag momentum.
 *
 * This file is not imported by the app. Restore the live gallery by copying
 * this file over `ah-media-carousel.ts` and renaming the class / tag back to
 * `AhMediaCarousel` / `ah-media-gallery-v32`, or register this element as
 * `ah-media-gallery-v32-stable` on its own.
 */
import {
 ...
 */
export class AhMediaGalleryV32Stable extends ElementBase {
...
declare global {
  interface HTMLElementTagNameMap {
    "ah-media-gallery-v32-stable": AhMediaGalleryV32Stable;
  }
}

export function defineAhMediaGalleryV32Stable() {
  if (
    typeof window !== "undefined" &&
    !customElements.get("ah-media-gallery-v32-stable")
  ) {
    customElements.define("ah-media-gallery-v32-stable", AhMediaGalleryV32Stable);
  }
}
